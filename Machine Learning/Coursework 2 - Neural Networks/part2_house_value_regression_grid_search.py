...
class MutliLinearRegression(nn.Module):
    def __init__(self, n_input_vars, n_output_vars, nb_hidden):
        ...
        if nb_hidden == 3:
            ...
            hidden_size = [32, 64, 32, 16]
        elif nb_hidden == 5:
            hidden_size = [32, 64, 64, 32, 16]
        elif nb_hidden == 6:
            hidden_size = [32, 64, 128, 64, 32, 16]
...
def example_main():
    ...
    regressor =  Regressor(x_train, nb_epoch=150, nb_batch=128, nb_hidden=6)
